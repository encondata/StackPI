...
// Map IANA timezone → operator-friendly label shown under the date.
// We operate globally; the lookup table covers commonly-deployed regions
// with readable region names. For any IANA zone not in the table, we
// fall back to "Continent / City" reformatted from the IANA name itself
// — always produces something the operator can sanity-check rather than
// hiding the value.
...
function friendlyTimezone(iana: string | null | undefined): string {
  if (!iana) return "";
